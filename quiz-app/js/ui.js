...
UI.prototype.soruGoster = function(soru) {
    ...
    for(let [key,value] of Object.entries(soru.cevapSecenekleri)) { //Object.entries metodu key ve value değerlerine for of döngüsü kullanarak erişmeyi sağlar.
...
UI.prototype.disableAllOption = function() {
    const options = document.querySelectorAll(".option"); //for of döngüsü DOM elemanlarını içeren bir NodeList döndürüyor. NodeList aslında bir dizi gibi davranan ancak farklı bir türde olan bir koleksiyon.Bu nedenle üzerinde for of döngüsü kullanılıyor. for in ise nesnelerin anahtarları ve dizilerin indekslerinde kullanılıyor genelde. for of ise diziler ve iterable yapılar(nodelist,map,set gibi)
